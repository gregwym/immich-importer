...
SOURCES = [('__init__',
 ...
 ('runner',
  ...
  '                progress("[" + str(index) + "/" + str(len(hashing)) + "] hashing: " + '
  'item.relative)\n'
  '                try:\n'
  ...
  '                    for item in matches:\n'
  '                        fail(item, "Identical bytes in two members of one bundle/stack; needs '
  'review")\n'
  '            for key, members in plan.bundles.items():\n'
  '                try:\n'
  ...
  '                if item.error:\n'
  '                    continue\n'
  '                progress("[" + str(index) + "/" + str(len(pending)) + "] upload/verify: " + '
  'item.relative)\n'
  '                try:\n'

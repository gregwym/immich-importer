...
SOURCES = [('__init__',
 ...
 ('scan',
  ...
  '                    member.route, member.reason = "timeline", "Insta360 360 bundle (no LRV; '
  'master shown in timeline)"\n'
 ...
 ('api',
  ...
  '        if not existing:\n'
  '            response = self.request("POST", "/stacks", json={"assetIds": [primary.asset_id] + '
  '[c.asset_id for c in children]})\n'
  ...
  '        else:\n'
  '            raise ImportFailure("STACK CONFLICT: RAW and rendered photo are in different '
  'stacks")\n'
  ...
  '            raise ImportFailure("STACK CONFLICT: existing stack does not match the RAW/rendered '
  'pair")\n'
  '        return stack_id\n'
  '\n'
